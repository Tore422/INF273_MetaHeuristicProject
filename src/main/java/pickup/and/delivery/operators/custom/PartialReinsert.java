    ...
    public static IVectorSolutionRepresentation<Integer> usePartialReinsertOnSolution(
       ...
       // while (true) {
            ...
            if (!vehiclesProcessedSoFar.contains(randomIndex)) {
                ...
                System.out.println("costOfInitialSolution = " + costOfInitialSolution);
                int numberOfDifferentCallsInVehicle = findNumberOfDifferentCallsInVehicle(
                        startAndStopIndexOfVehicle[0], startAndStopIndexOfVehicle[1]);
                System.out.println("numberOfDifferentCallsInVehicle = " + numberOfDifferentCallsInVehicle);
                ...
                if (bestCostSoFarForCurrentVehicle > costOfInitialSolution) {
                    int partOfCallToReinsert = newSolutionRepresentation.get(indexOfCallToMove);
